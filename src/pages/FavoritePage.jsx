...
const FavoritePage = () => {
  ...
  return (
    <div className="w-full h-fit flex flex-col pt-28 px-20 gap-y-5 pb-20">
        ...
        {data?.map((el, i) => {
          return (
            <div className="flex-col flex gap-y-1">
              ...
              <button className="flex gap-x-2 w-full py-2 bg-red-600 rounded items-center justify-center text-white hover:bg-red-700 transition-all duration-300 ease-in-out">
                {" "}
