  ...
  return (
    <nav
      className={`${
        ...
        isScroll && !theme
          ? "bg-white shadow-md transition duration-300 ease-in"
          : ""
      }`}
    >
      <div className="p-1 px-3 lg:px-10 flex items-center justify-between w-full relative">
        ...
        <div className="flex items-center ml-10 gap-10 text-[15px] lg:text-[18px] font-semibold">
          <NavLink
            ...
            <span className={`nav${theme ? "text-white" : "text-black"}`}>
              Home
            </span>
          </NavLink>
          <NavLink
            ...
            isActive
              ? "border-red-500 border-b-2 text-red-500"
              : "relative hover:text-red-500 nav"
          }>
            <span className={`nav${theme ? "text-white" : "text-black"}`}>
              Movies
            </span>
        ...
        <div className="flex gap-3 items-center font-semibold">
          <button className="px-1" onClick={() => setTheme(!theme)}>
            {theme ? (
              <BiMoon className="text-white w-6 h-6 lg:w-7 lg:h-7" />
            ) : (
              <BiSun className=" text-black w-6 h-6 lg:w-7 lg:h-7" />
            )}
          </button>
            ...
            {currentUser !== null ? (
              <>
                <div className="relative">
                  <div className={`w-7 h-7 lg:w-9 lg:h-9 rounded-full overflow-hidden border ${theme? "border-gray-400" : "border-black"}`}>
                    <img
                  ...
                  {open && (
                    <div className={`absolute rounded-lg w-52 -right-1 lg:-right-1 mt-2 shadow-sm ${theme? "bg-zinc-900 shadow-black" : "bg-zinc-200"}`}>
